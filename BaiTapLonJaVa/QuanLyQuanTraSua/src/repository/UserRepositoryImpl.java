...
public class UserRepositoryImpl implements IUserRepository {
    ...
    private static int currentId = 1; // Bộ đếm ID bắt đầu từ 1
        ...
        try (InputStream fis = new FileInputStream(file);
            ...
            if (obj instanceof List<?>) {
                ...
                if (!list.isEmpty() && list.get(0) instanceof User) {
                    ...
                    currentId = users.get(users.size() - 1).getMaNV() + 1;
    ...
    private void initializeUsers() {
        ...
        users.add(new User(1, "Nguyễn Lê Hoài Nam", "namngyenhoai21@gmail.com", 12345678, "Address1", "123", "ADMIN"));
        users.add(new User(2, "Nguyễn Văn Hậu", "nguyenvanhau@gmail.com", 123456789, "Address2", "123", "ADMIN"));
        users.add(new User(3, "Nguyễn Hồng Diễn", "nguyenhongdien@gmail.com", 1234567, "Address3", "123", "ADMIN"));
    ...
    private int generateNewId() {
    	return users.isEmpty() ? 1 : users.get(users.size() - 1).getMaNV() + 1;
    	}
}
